    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="glass-panel w-full max-w-lg rounded-3xl overflow-hidden p-6 border border-slate-700/60 space-y-6">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-center justify-between">
          <span className="text-xs text-slate-300 font-semibold">云端托管</span>
        ...
        <div className="pt-4 border-t border-slate-800 space-y-3">
          <h4 className="text-xs font-bold uppercase text-slate-400 tracking-wider">数据重置</h4>
        ...
        <div className="pt-2 flex justify-end">
          <button
            ...
            className="bg-slate-800 hover:bg-slate-700 text-slate-300 px-6 py-2 rounded-xl text-xs font-semibold transition-colors"
          >
            关闭
          </button>
        </div>
